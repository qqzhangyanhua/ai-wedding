...
import { Camera, Clock, CheckCircle, AlertCircle, Plus, ArrowRight, Sparkles, Loader2 } from 'lucide-react';
              ...
              >
                <div className="relative aspect-video overflow-hidden">
                  ...
                  <div className="absolute top-3 right-3 flex items-center gap-2 px-3 py-1.5 bg-white/90 backdrop-blur-sm rounded-full">
                    {getStatusIcon(project.generation?.status || project.status)}
                    <span className="text-sm font-medium text-gray-900">{getStatusText(project.generation?.status || project.status)}</span>
                  </div>
