...
import { Camera, Clock, CheckCircle, AlertCircle, Plus, ArrowRight, Sparkles, Loader2, Heart, Download, RefreshCw } from 'lucide-react';
...
export function DashboardPage({ onNavigate }: DashboardPageProps) {
  ...
  const { projects, loading, refreshProjects, hasProcessingProjects } = useProjects();
